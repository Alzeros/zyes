...
const translations = {
  zh: {
    ...
    'settings.about': '关于',
    'settings.cardSize': '卡片设置',
    'about.title': '关于 Zyes',
    'about.version': '版本',
    'about.tagline': '书签导航与聚合搜索门户',
    'about.close': '关闭',
    'cardSize.title': '卡片设置',
    'cardSize.hint': '调整卡片显示尺寸;手机端可手动开启长按拖拽排序。',
    'cardSize.preview': '预览',
    'cardSize.apply': '完成',
  ...
  en: {
    ...
    'about.close': 'Close',
    'cardSize.title': 'Card Settings',
    'cardSize.hint': 'Adjust card size; on touch devices you can opt in to long-press drag-to-reorder.',
